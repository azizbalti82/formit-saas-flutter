...
class _State extends State<FormSettings> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                title(title: "General"),
                settingsItemToggle(
                  title: "FormIt Branding",
                  desc: "Show 'Made with FormIt' on your form.",
                  isEnabled: formitBranding,
                  isProFeature: false,
                  onToggle: (value) {
                    setState(() {
                      formitBranding = !formitBranding;
                    });
                  },
                ),
                /*
  ...
  Widget _buildAppBarContent(theme theme) {
    return Row(
      children: [
        ...
        SizedBox(width: 10),
        Text(
          isLandscape(context) ? "Form Settings" : "Settings",
        ...
        (!isLandscape(context))
            ...
            : FButton.icon(
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(width: (!isSavingLoading)?0:40),
                    (isSavingLoading)
                        ? SizedBox(
                            width: 10,
                            height: 10,
                    ...
                    SizedBox(width: (!isSavingLoading)?10:40),
                  ],
                ),
              ),
      ],
  ...
  title({required String title}) {
    return Padding(
      ...
      child: Text(title, style: TextStyle(color: t.accentColor, fontSize: 20)),
    );
  }
    ...
    return Column(
      children: [
        FTappable(
          ...
          child: Padding(
            padding: EdgeInsets.only(right: 20, left: 8, top: 5, bottom: 5),
            child: Row(
              children: [
                Expanded(
                  child: Column(
        ...
        SizedBox(height: 5),
        Divider(color: t.textColor.withOpacity(0.06)),
        SizedBox(height: 5),
      ],
    );
  }
